...
func (p *kProductCatalogServiceClient) InsertProducts(ctx context.Context, Req *product.InsertProductsReq, callOptions ...callopt.Option) (r *product.Empty, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.InsertProducts(ctx, Req)
}

func (p *kProductCatalogServiceClient) DeleteProducts(ctx context.Context, Req *product.DeleteProductsReq, callOptions ...callopt.Option) (r *product.Empty, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteProducts(ctx, Req)
}

func (p *kProductCatalogServiceClient) UpdateProducts(ctx context.Context, Req *product.UpdateProductsReq, callOptions ...callopt.Option) (r *product.Empty, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
